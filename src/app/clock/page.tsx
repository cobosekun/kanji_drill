    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-sky-100 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <button
          ...
          onClick={onStart}
          aria-label="ドリルをはじめる"
          className="w-full py-5 bg-gradient-to-r from-amber-400 to-sky-400 text-white text-2xl font-bold rounded-3xl shadow-xl hover:shadow-2xl transform hover:scale-[1.02] active:scale-95 transition-all"
        >
          🕐 はじめる！
        </button>
